          ...
          <span className="photoDetail__image--like">
            ...
            >
              <path
                ...
                fill="#0C1E1A"
              />
            </svg> {photoDetails.likes} likes
          </span>
        <p className="photoDetail__image--time">{new Date(photoDetails.timestamp).toLocaleDateString()}</p>
      </div>
      <div className="photoDetail__image--photographer">
        <span className ="photoDetail__image--photographer">Photo by </span>{photoDetails.photographer}
      </div>
    </div>
  );
}
